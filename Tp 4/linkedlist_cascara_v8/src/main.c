...
int main(void)
{
   /// demiandes@gmail.com
        ...
        //startTesting(11); // ll_indexOf//MAL//con un get recorro y trato de encontrar el dato(dame 0el idice de un elemento en particular)
        ...
        //startTesting(15); // ll_contains//recive unn puntero a y dice si se encuentra
        //startTesting(16); // ll_containsAll//
        //startTesting(17); // ll_subList//de toda la  lsita me devuelve un pedazo (si le paso del 1 al 2 me devuelve un lista que contenga esas listas)
        //startTesting(18); // ll_clone// crea una lista nueva (nuevalista = lista; Esta mal)(creo una nueva lista y copio los elementos usando un get y poniendolo en la copiad con un add)
