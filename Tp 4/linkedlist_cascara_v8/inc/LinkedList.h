...
struct Node
{
    void* pElement; //el elemento que guardo en la estructura               //puntero al elemento (persona, empleado, etc.)
...
{
    Node* pFirstNode;
    int size;//tamanio de                       //cada vez que agrego o elimino un elemento size++/--
}typedef LinkedList;
#endif
